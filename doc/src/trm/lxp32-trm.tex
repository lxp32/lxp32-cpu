...
The \lxp{} CPU can be programmed in the assembly language covered by Appendix \ref{app:assemblylanguage}.
...
This feature is designed with the assumption that read and write transactions don't cause side effects, thus it can be unsuitable for some slaves.
